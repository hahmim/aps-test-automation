...
//    JdbcTemplate jdbcTemplate = (JdbcTemplate) ctx.getBean("JdbcTemplate");
	...
	public static String findCurrentIdentytyById = "Select CurrId.NAME_PREFIX,CurrId.NAME_SUFFIX,CurrId.FIRST_NAME,CurrId.LAST_NAME,CurrId.MIDDLE_NAME, CurrId.GENDER, CurrId.DOB, CurrId.SSN, CurrId.NPI, "
	...
	public CurrentIdentity findByCurrentIdentityAttrById(int currId) {
	       return jdbcTemplate.queryForObject(
	    		   findCurrentIdentytyById,
	               new Object[]{currId}, new IdentityRowMapper());
	}
}
